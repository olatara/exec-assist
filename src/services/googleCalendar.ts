...
export const findFreeMeetingSlots = async (
  ...
  const allBusyTimes: TimePeriod[] = Object.values(
  ...
  return {
    individualBusyTimes: formatIndividualBusyTimes(
      response.data.calendars || {}
    ),
...
const findFreeTimes = (
  ...
  busyTimes
    ...
    .forEach((busy) => {
      ...
      if (currentTime < busyStart) {
        freeTimes.push({
          start: formatDate(currentTime, "yyyy-MM-dd'T'HH:mm:ssXXX"),
          end: formatDate(busyStart, "yyyy-MM-dd'T'HH:mm:ssXXX"),
        });
      }
  ...
  if (currentTime < end) {
    freeTimes.push({
      start: formatDate(currentTime, "yyyy-MM-dd'T'HH:mm:ssXXX"),
      end: formatDate(end, "yyyy-MM-dd'T'HH:mm:ssXXX"),
    });
  }
...
const formatIndividualBusyTimes = (calendars: {
